...
if (isset($_SESSION['login']) && isset($_SESSION['birthday'])) {
    ...
    <nav class="bg-gray-50 border-gray-200 dark:bg-gray-900">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
            ...
            <div class="flex items-center text-sm font-medium">
                ...
                <a href="<?= $login ? 'logout.php' : 'login.php' ?>"
                            ...
                            <div class="h-full flex flex-col justify-between md:w-4/5 ml-auto mr-0">
                                <div>
                                    ...
                                    <p class="mt-6 mb-3 text-lg lg:text-xl">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis et ex in, qui
                                        ab cumque alias
