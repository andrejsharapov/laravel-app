<div class="grid place-content-center w-full h-full">
    <div class="flex justify-center">
        <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white">
            <img class=" w-full h-96 md:h-auto object-cover md:w-48 rounded-lg" src="<?php echo $data ? $data['image'] : 'https://source.unsplash.com/collection/3319466' ?>" alt="" />
            <div class="px-6 flex flex-col justify-start">
                ...
                <a href="?url=about" class="mt-4 text-center bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                    About author
                </a>
            </div>
        </div>
